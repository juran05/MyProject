...
<body>
	<div class="container">
		...
		<div class="row">
		<form action="login_ok0801.jsp" method="post">
		<table class="table">
			<tr>
				<th class="text-right info" width="25%">아이디</th>
			...
			<tr>
				<th class="text-right info" width="25%">비밀번호</th>
				<td class="text-left" width="75%">
			...
			<tr>
				<td colspan ="2" class="text-center">
					...
					<input type=submit value="취소" class="btn btn-sm btn-warning">
				</td>
			</tr>
		</table>
		</form>
